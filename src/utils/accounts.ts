 ...
 * @returns void
 */
export const assertIsValidAddress = (address: string, prefix = ACCOUNTS.AddressBech32Prefix): void => {
 ...
 */
export const isValidAddress = (address: string, prefix = ACCOUNTS.AddressBech32Prefix): boolean => {
  const ALLOWED_CHARS = 'qpzry9x8gf2tvdw0s3jn54khce6mua7l';
  const regexp = new RegExp(`^(${prefix})1([${ALLOWED_CHARS}]+)$`); // Prefix + bech32 separated by '1'
